...
class TopNewsAdapter : BaseAdapter<Article>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        ViewCompat.setTransitionName(holder.itemView.ivArticleImage, getItemOnPosition(holder.adapterPosition).publishedAt)
        ViewCompat.setTransitionName(holder.itemView.tvArticleTitle, (getItemOnPosition(holder.adapterPosition).publishedAt+"title"))

        super.onBindViewHolder(holder, position)

        holder.itemView.setOnClickListener {
            onClickWithTransition?.invoke(getItemOnPosition(holder.adapterPosition),it.ivArticleImage,it.tvArticleTitle)
