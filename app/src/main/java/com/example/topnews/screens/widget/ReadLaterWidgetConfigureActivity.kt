 ...
 */
class ReadLaterWidgetConfigureActivity : Activity() {
	...
	internal var mOnClickListener: View.OnClickListener = View.OnClickListener {
		val context = this@ReadLaterWidgetConfigureActivity
		...
		ReadLaterWidget.updateAppWidget(context, appWidgetManager, mAppWidgetId)
	...
	public override fun onCreate(icicle: Bundle?) {
		...
		setContentView(R.layout.read_later_widget_configure)
	...
	companion object {
		...
		private val PREFS_NAME = "com.example.topnews.screens.widget.ReadLaterWidget"
